...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{analysis/model_convergence/images/jump_penalties.png}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{analysis/model_convergence/images/jump_penalties_box.png}
    \caption{Hyper-tuning.}
    \label{fig:jump_penalties}
\end{figure}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{analysis/model_convergence/images/simulation_normal.png}
    \caption{Hyper-tuning.}
    \label{fig:jump_penalties}
\end{figure}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{analysis/model_convergence/images/simulation_t.png}
    \caption{Hyper-tuning.}
    \label{fig:jump_penalties}
\end{figure}
